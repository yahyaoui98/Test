...
font-size: 16px;">  &nbsp; <a href="#" class="btn btn-danger square-btn-adjust">Logout</a> </div>
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a   href="affichage_activite.php"><i class="fa fa-dashboard fa-3x"></i> Activite </a>
                    </li>
                     <li>
                        <a class="active-menu" href="affichage_pack.php"><i class="fa fa-desktop fa-3x"></i> Packs</a>
                    </li>
                    <li>
...
<a href="stat.php"><button type="button" class="btn btn-primary btn-lg">Statistique</button></a>
<a href="formPack.php"><button type="button" class="btn btn-primary btn-lg">+ Ajouter</button></a>
...
foreach($listePack as $row){
    ...
    <td><a href="modifierPack.php?id=<?PHP echo $row['id']; ?>"> Modifier</a></td>
    </tr>
